...
# from app_1.application import Application
# from features777.logger import MyListener, logger
...
def browser_init(context, name):
    ...
    """
    context.driver = webdriver.Chrome(executable_path='/Users/andrei/PycharmProjects/gettop/chromedriver')
